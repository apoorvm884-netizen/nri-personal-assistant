...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-1.25-1.25m0 0l-1.25-1.25m1.25 1.25l-1.25-1.25m1.25 1.25l3.75-3.75m0 0L18 9.75m-1.5 1.5l1.5-1.5m-1.5 1.5l-3.75-3.75" />
      </svg>
    ),
  },
]
    ...
    <div className="min-h-screen bg-charcoal-50/50 flex">
      ...
      <aside className={`fixed md:sticky top-0 left-0 z-50 h-screen w-64 bg-charcoal-800 flex flex-col transition-transform duration-300 ${
        ...
        <div className="flex items-center justify-between px-5 h-16 md:h-20 border-b border-charcoal-700">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-serif text-base font-semibold text-white">Admin Panel</span>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive ? 'bg-primary-500/10 text-primary-400' : 'text-charcoal-300 hover:bg-charcoal-700 hover:text-white'
                }`
              }
            >
              {item.icon}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-charcoal-100 h-16 md:h-20 flex items-center px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-charcoal-800 rounded-full">
              <span className="text-xs font-medium text-primary-400">Admin</span>
            </div>
